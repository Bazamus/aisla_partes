...
export default function ProcesarPendientes({ onProcessComplete }) {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
      <h2 className="text-xl font-semibold text-gray-800 mb-4">Procesar Todos los Usuarios Pendientes</h2>
