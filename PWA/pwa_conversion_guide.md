...
La aplicacion esta desplegada en produccion en Vercel y tiene un dominio personalizado asignado con certificado SSL: https://partes.aclimar.com
...
VitePWA({
  ...
  manifest: {
    name: 'Aclmar Partes de Trabajo',
    short_name: 'Aclimar_Gestor',
    description: 'Gestor Partes de Trabajo',
    theme_color: '#ffffff',
...
--- Para generar los iconos requeridos usa la imagen contenida en esta carpeta "PWA"
...
6. **Es muy importante que el desarrollo de esta funcionalidad no afecte en nada a la vista y uso de la aplicacion en Desktop, no modificar nada del diseño
